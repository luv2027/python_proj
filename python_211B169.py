...
class bus_booking:
    ...
    def cover_page(self):
        ...
        Label(root, text="\n\nName: Madhook Parashar", font='Arial 16 bold', fg='blue').pack()
        Label(root, text="\nEnrollment No. : 211B169", font='Arial 16 bold', fg='blue').pack()
        Label(root, text="\nMobile : 7999199486\n", font='Arial 16 bold', fg='blue').pack()
        Label(root, text="Submitted to: Dr. Mahesh Kumar Sir", font='Arial 15 bold', bg='light blue', fg='red').pack()
        ...
        def show_bus():
            ...
            if tp.isalpha() and fp.isalpha():
                if not jd=='':
                                            ...
                                            if len(name)>0 and len(name)<20:
                                                if age>0 and age<150:
                                                    if seats>0 and seats<11:
                                                        ...
                                                        showerror("! booking limit exceed","please you can only book upto 10 seats")
                                                else:
                    ...
                    showerror('Error!','please! Enter journey date')
